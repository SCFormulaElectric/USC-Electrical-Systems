...
#pragma config FOSC = INTOSCIO // Oscillator Selection bits (Internal oscillator, GP4/GP5 are IO)
#pragma config WDTE = OFF      // Watchdog Timer Enable bit (WDT disabled)
#pragma config PWRTE = OFF     // Power-up Timer Enable bit (PWRT disabled)
#pragma config MCLRE = OFF     // GP3/MCLR pin function select bit (GP3 is Digital I/O, MCLR internally tied to VDD)
